...
| Codex | Inspeção/exportação por arquivo e descoberta sob raiz explícita experimentais; fixtures sintéticas, compatibilidade real pendente | Integração da etapa 05 | Aguardar pesquisa da fonte | Não comprovado |
