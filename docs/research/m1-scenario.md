...
4. Clonar o commit base em outro diretório e ler `HANDOFF.md` sem instalar Memory Bee. Conferir manifesto e aplicar explicitamente as mudanças; terminar a validação de entrada e executar os testes.
