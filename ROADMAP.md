...
| Primeiro leitor | Claude Code implementado por arquivo explícito e fixtures sintéticas; descoberta por projeto e compatibilidade real pendentes. Codex seguinte. |
