...
```sh
cargo run --locked -- workspace --claude --project . --state /tmp/bee-claude-state
...
da moldura Bee; memória/exportação integrada, perfis isolados e interface de
conversa própria continuam pendentes. Contrato e teclas em
